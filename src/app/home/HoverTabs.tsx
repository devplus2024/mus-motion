...
export const HoverTabs = (): JSX.Element => {
  ...
  return (
    ...
    >
          ...
          <NavigationMenuItem className="">
            <NavigationMenuTrigger
              className={classNames(
                "text-sm relative rounded-full flex items-center h-7 px-3 z-[30]   text-[#a1a1a1] cursor-pointer select-none transition-colors",
                {
                  "text-white": hoveredTabIndex === 0,
          ...
          <NavigationMenuItem>
            <Link href="/docs" legacyBehavior passHref>
              <NavigationMenuLink className={navigationMenuTriggerStyle()}>
                <button
                  className={classNames(
                    "group inline-flex h-7 w-max items-center hover:bg-[#1f1f1f] justify-center rounded-full  px-3  text-sm font-medium transition-colors  text-[#a1a1a1] hover:text-accent-foreground  disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50 data-[active]:text-white data-[state=open]:bg-accent/50 data-[state=open]:text-white",
                    {
      ...
      <div
        className="absolute z-0 top-0 left-0 rounded-full bg-[#1f1f1f] transition-[width]"
        style={hoverStyles}
      />
    </nav>
  );
