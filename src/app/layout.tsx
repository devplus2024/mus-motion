            ...
            <ToasterSonner
              ...
              toastOptions={{
                ...
                classNames: {
                  ...
                  closeButton:
                    "dark:bg-black left-[330px] top-1/2 -translate-y-1/2 border border-[#404040] transition-[background] transition-colors  ease-out duration-500 bg-white hover:bg-muted dark:hover:bg-white dark:hover:text-black",
                },
              }}
              closeButton
              className="top-[38px]"
