...
export const ThemeToggle = ({
  ...
  return (
    <>
      ...
      <div
        className="radix-themes-custom-fonts flex h-[36px] w-[37px] items-center justify-center rounded-md transition-all duration-200 ease-out hover:bg-muted dark:hover:bg-[#101010]"
