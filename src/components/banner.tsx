...
export function Banner({
  ...
  return (
    <div
      ...
      {...props}
      className={cn(
        "bg-fd-secondary sticky top-0 z-40 flex h-12 flex-row items-center justify-center px-4 text-center text-sm font-medium",
        ...
        <button
          ...
          className={cn(
            buttonVariants({
              color: "ghost",
              className:
                "text-fd-muted-foreground absolute end-2 top-1/2 -translate-y-1/2",
              size: "icon",
            }),
          )}
        >
