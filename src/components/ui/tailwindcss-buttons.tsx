export default function TailwindcssButton() {
  return (
    <button className="group relative mt-[1rem] inline-block cursor-pointer rounded-full bg-slate-800 p-px text-xs font-semibold leading-6 text-white no-underline shadow-2xl shadow-zinc-900">
