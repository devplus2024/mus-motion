  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "relative h-[cacl(100vh-59px)] w-[--sidebar-width] bg-transparent transition-[width] duration-200 ease-linear",
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-10 hidden h-[cacl(100vh-59px)] w-[--sidebar-width] pt-[4rem] transition-[left,right,width] duration-200 ease-linear md:flex",
            side === "left"
